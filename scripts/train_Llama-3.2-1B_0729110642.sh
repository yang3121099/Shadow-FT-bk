...
mkdir -p "/root/shadow_exp/new_shadow/Shadow/results/0729/result-Llama-3.2-1B-0729/B-2k-lora-rank128-lr0.0002-Shadow_2k"
...
llamafactory-cli train \
  ...
  --cutoff_len 4096 \
  --max_samples 2000 \
  --output_dir "/root/shadow_exp/new_shadow/Shadow/results/0729/result-Llama-3.2-1B-0729/B-2k-lora-rank128-lr0.0002-Shadow_2k" \
...
mkdir -p "/root/shadow_exp/new_shadow/Shadow/results/0729/result-Llama-3.2-1B-0729/I-2k-lora-rank128-lr0.0002-Shadow_2k"
cd "/root/shadow_exp/new_shadow/Shadow"
llamafactory-cli train \
  ...
  --cutoff_len 4096 \
  --max_samples 2000 \
  --output_dir "/root/shadow_exp/new_shadow/Shadow/results/0729/result-Llama-3.2-1B-0729/I-2k-lora-rank128-lr0.0002-Shadow_2k" \
  --per_device_train_batch_size 2 \
  --gradient_accumulation_steps 16 \
  --learning_rate 0.0002 \
  --num_train_epochs 1 \
...
##### LoRA delta-merge #####
mkdir -p "/root/shadow_exp/new_shadow/Shadow/results/0729/result-Llama-3.2-1B-0729/B-2k-lora-rank128-lr0.0002-Shadow_2k/merge-B2I"
python3 /root/shadow_exp/new_shadow/Shadow/src/shadow/merge_lora.py \
  --adapter_path "/root/shadow_exp/new_shadow/Shadow/results/0729/result-Llama-3.2-1B-0729/B-2k-lora-rank128-lr0.0002-Shadow_2k" \
  --target_base "meta-llama/Llama-3.2-1B-Instruct" \
  --merge_tag "B2I" \
  --template "llama3"

mkdir -p "/root/shadow_exp/new_shadow/Shadow/results/0729/result-Llama-3.2-1B-0729/I-2k-lora-rank128-lr0.0002-Shadow_2k/merge-I2I"
python3 /root/shadow_exp/new_shadow/Shadow/src/shadow/merge_lora.py \
  --adapter_path "/root/shadow_exp/new_shadow/Shadow/results/0729/result-Llama-3.2-1B-0729/I-2k-lora-rank128-lr0.0002-Shadow_2k" \
  --target_base "meta-llama/Llama-3.2-1B-Instruct" \
  --merge_tag "I2I" \
  --template "llama3"

mkdir -p "/root/shadow_exp/new_shadow/Shadow/results/0729/result-Llama-3.2-1B-0729/I-2k-lora-rank128-lr0.0002-Shadow_2k/merge-I2B"
python3 /root/shadow_exp/new_shadow/Shadow/src/shadow/merge_lora.py \
  --adapter_path "/root/shadow_exp/new_shadow/Shadow/results/0729/result-Llama-3.2-1B-0729/I-2k-lora-rank128-lr0.0002-Shadow_2k" \
...
mkdir -p "/root/shadow_exp/new_shadow/Shadow/results/0729/result-Llama-3.2-1B-0729/B-2k-lora-rank128-lr0.0002-Shadow_2k/merge-B2B"
python3 /root/shadow_exp/new_shadow/Shadow/src/shadow/merge_lora.py \
  --adapter_path "/root/shadow_exp/new_shadow/Shadow/results/0729/result-Llama-3.2-1B-0729/B-2k-lora-rank128-lr0.0002-Shadow_2k" \
  --target_base "meta-llama/Llama-3.2-1B" \
  --merge_tag "B2B" \
