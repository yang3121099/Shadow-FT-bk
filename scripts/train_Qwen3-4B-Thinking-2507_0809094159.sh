##### Auto-generated 2025-08-09 09:41:59 #####
...
mkdir -p "/home/ubuntu/Shadow/results/0809/result-Qwen3-4B-Thinking-2507-0809/I-1k-lora-rank128-lr0.0002-s1k_gptoss20b_high"
cd "/home/ubuntu/Shadow"
llamafactory-cli train \
  ...
  --cutoff_len 32768 \
  --max_samples 1000 \
  --output_dir "/home/ubuntu/Shadow/results/0809/result-Qwen3-4B-Thinking-2507-0809/I-1k-lora-rank128-lr0.0002-s1k_gptoss20b_high" \
  --per_device_train_batch_size 2 \
  --gradient_accumulation_steps 16 \
  --learning_rate 0.0002 \
  --num_train_epochs 1 \
